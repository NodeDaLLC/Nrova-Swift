...
/// by a shared transport and the configured ``NrovaConfiguration``.
///
/// ```swift
/// let client = NrovaClient(apiKey: "sk_live_…")
...
/// ```
public struct NrovaClient: Sendable {
    public let configuration: NrovaConfiguration
    public let transport: NrovaTransport
    ...
    /// Construct a client from a fully prepared ``NrovaConfiguration``.
    public init(
