...
public enum NodeDaError: Error, Sendable {
    ...
    /// Structured payload returned by every NodeDa Vertex Cloud Function on failure.
...
extension NodeDaError: LocalizedError {
    public var errorDescription: String? {
        ...
        case .decoding(let underlying, _):
            return "Failed to decode NodeDa Vertex response: \(underlying.localizedDescription)"
